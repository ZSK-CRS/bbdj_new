...
//快递信息，收件人，寄件人信息
public class MyAddressActivity extends BaseActivity implements XRecyclerView.LoadingListener {
    ...
    private MyAddressAdapter messageAdapter;
    ...
    private void requestData() {
        ...
        Request<String> request = NoHttpRequest.getMyAddressRequest(user_id);
    ...
    private void initClickListener() {
        //点击删除
        messageAdapter.setDeleteClickListener(new MyAddressAdapter.OnDeleteClickListener() {
            @Override
        ...
        //点击编辑
        messageAdapter.setEditClickListener(new MyAddressAdapter.OnEditClickListener() {
            @Override
            public void onClick(int position) {
                //跳转编辑
        ...
        //选中
        messageAdapter.setItemClickListener(new MyAddressAdapter.OnItemSelectClickListener() {
            @Override
    ...
    private void deleteAddress(HashMap<String, String> addressMap) {
        ...
        Request<String> request = NoHttpRequest.deleteMyAddressRequest(user_id,addressMap.get("book_id"));
    ...
    private void initList() {
        mList = new ArrayList<>();
        messageAdapter = new MyAddressAdapter(mList);
